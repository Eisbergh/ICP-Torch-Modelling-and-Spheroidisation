# ICP Torch Modelling and Titanium Particle Spheroidisation
...
|---|---:|
| RF frequency | 3 MHz |
| Carrier argon flow | 1 slpm |
| Main argon flow | 3 slpm |
| Sheath argon flow | 31 slpm |
| Torch axial length | 200 mm |
| Torch radius | 25 mm |
| Coil axial positions | 63, 92 and 121 mm |
| Coil radius | 33 mm |
| Reference coil current | 161 A |
| Reference absorbed power | approximately 5 kW |
| Wall/inlet temperature | 300 K |
...
1. **Coil in air** (`sigma = 0 S/m`) with comparison against the analytical Biot-Savart centreline magnetic field.
2. **Conducting-medium test** (`sigma = 2500 S/m`) with comparison against the analytical skin-depth approximation.
...
1. reach complete melting, and
2. retain at least 90% of their initial mass.
